...
export function EditScenario({route}: {route: any}) {
  ...
  function handleSaveNome() {
      ...
      if (updatedScenari[index]) {
          ...
          scenari = updatedScenari;
          saveData('scenari', JSON.stringify(scenari)).then(() => {
              Alert.alert('Nome Aggiornato', `Il nome dello scenario è stato aggiornato a "${nome}".`, [{text: 'OK'}]);
          });
      }
  }
      ...
      <AndroidSafeArea>
          <ScrollView
              ...
              <View className="mt-5 ">
                  ...
                  />
                  <TouchableOpacity
                      className="flex rounded-xl p-5 bg-blue-500 justify-center items-center"
